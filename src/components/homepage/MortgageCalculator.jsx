      ...
      <div className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex gap-3 items-start p-3 bg-blue-50 text-blue-800 rounded-xl text-xs font-medium leading-relaxed">
            ...
            <p>Includes a buffer for potential rate increases.</p>
          </div>
          <div className="flex gap-3 items-start p-3 bg-amber-50 text-amber-800 rounded-xl text-xs font-medium leading-relaxed">
            ...
            <p>Most home loans in the UAE have terms up to 25 years, based on your age (up to 65 or 70 for self-employed).</p>
          </div>
        </div>
...
export default function PerfectMortgageCalculator() {
    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 text-slate-800" style={{ fontFamily: '"DM Sans", sans-serif' }}>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 bg-white p-6 rounded-2xl">
  ...
  <div className="bg-gradient-to-br from-purple-900 to-indigo-900 rounded-[2rem] p-8 text-white shadow-2xl shadow-purple-900/20 relative overflow-hidden flex flex-col justify-between h-full">
          ...
          isEligible ? (
            <div>
              ...
              <div className="border-t border-purple-800/50 pt-6 flex justify-between items-center">
                <div>
                  <p className="text-purple-300 text-xs font-semibold mb-1 uppercase tracking-wide">
                ...
                <button
                  ...
                  className="bg-white/10 hover:bg-white/20 px-4 py-2 rounded-xl text-sm font-semibold transition flex items-center gap-2"
                >
            ...
            <div className="bg-white/10 border border-white/20 rounded-2xl p-6 backdrop-blur-sm">
              <div className="text-alert font-bold mb-2 flex items-center gap-2">
                Eligibility Issue
              </div>
              <p className="text-sm text-purple-100 font-medium">
                Minimum salary requirement of AED {MIN_SALARY.toLocaleString()} is not met.
              </p>
            </div>
          )
        ) : (
    ...
    <button
      onClick={() => openModal('preapproval')}
      className="mt-8 w-full bg-white text-[#5C039B] py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition shadow-lg flex justify-center items-center gap-2"
    >
